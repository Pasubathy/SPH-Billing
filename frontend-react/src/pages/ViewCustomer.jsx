        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'white', fontFamily: "'Manrope', sans-serif" }}>
                ...
                <div style={{ width: '280px', minWidth: '240px', background: 'white', borderRight: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
                    ...
                    <div style={{ flex: 1, overflowY: 'auto' }}>
                        {filteredCustomers.length === 0 ? (
                            <div style={{ padding: '24px', textAlign: 'center', color: 'var(--text-muted)', fontSize: '13px' }}>No customers found</div>
                        ) : (
                    ...
                    <div style={{ padding: '24px', flex: 1, overflowY: 'auto' }}>
                                ...
                                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', textAlign: 'left' }}>
                                    ...
                                    <tbody>
                                        {allTransactions.length > 0 ? (
                                            ...
                                            <tr>
                                                <td colSpan="7" style={{ padding: '24px', textAlign: 'center', color: '#64748B' }}>No transactions recorded for this customer</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </table>
                        ...
                        {activeTab === 'statements' && (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                ...
                                <div style={{ background: 'white', border: '1px solid #E2E8F0', borderRadius: '8px', padding: '24px', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
            ...
            {showDeleteModal && (
                <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999 }}>
                    <div style={{ background: 'white', borderRadius: '12px', width: '400px', padding: '24px', boxShadow: '0 10px 25px rgba(0,0,0,0.1)' }}>
